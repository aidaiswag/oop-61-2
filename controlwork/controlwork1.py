...
class BankAccount:
    ...
    def __eq__(self, other):
        return self.hero.name == other.hero.name and self.hero.lvl == other.hero.lvl and self.hero.hp == other.hero.hp
...
print("Бонус за уровень:", acc1.get_bonus_for_level(), "SOM")
